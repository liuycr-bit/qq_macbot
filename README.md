...
| 本地表情扩展 | 已完成 | `#meme` 独立路由、Worker/子进程隔离、NapCat 登录态头像桥、消息图片输入、中文别名层和 1544 个固定版本模板已在本机启用 |
...
- 增加独立的简体中文模板别名层：B3 全量模板及 C1 高频经典、动物、游戏、动图、多格和职场模板可直接用中文搜索和生成；上游英文键继续作为稳定编号保留。
